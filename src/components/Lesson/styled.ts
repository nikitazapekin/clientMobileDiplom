...
export const styles = StyleSheet.create({
  ...
  fillTaskCodeSlotFilled: {
    borderStyle: "solid",
    borderColor: "rgba(16, 185, 129, 0.55)",
  },
  fillTaskCodeSlotText: {
    color: "#111827",
    fontSize: 14,
    lineHeight: 20,
    fontFamily: "monospace",
  ...
  fillTaskOptionChip: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(159, 15, 167, 0.28)",
    backgroundColor: "#FFF8FF",
  },
  fillTaskOptionChipActive: {
    borderColor: "rgba(159, 15, 167, 0.65)",
    backgroundColor: "#F5E8F9",
  },
  fillTaskOptionChipGhost: {
    opacity: 0.28,
  },
  fillTaskOptionChipText: {
    color: COLORS.BLACK,
    fontSize: 14,
    fontFamily: "monospace",
  },
  fillTaskDragOverlay: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(159, 15, 167, 0.55)",
